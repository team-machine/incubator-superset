...
# COPY --chown=superset:superset superset sup# deps for superset 0.35.1
FROM eu.gcr.io/tm-preview/tm-superset-base-image:191213.072550
...
RUN chown -R superset:superset superset
...
USER superset
erset
RUN chown -R superset:superset /home/user/Projects/transpyle
